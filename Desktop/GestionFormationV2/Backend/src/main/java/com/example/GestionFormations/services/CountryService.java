...
public class CountryService {
    ...
    public void updateCountry(Long countryId, CountryEntity countryUpdate) {
        ...
        if (countryUpdate.getName()!=null &&
                countryUpdate.getName().length() > 0 &&
                !Objects.equals(country.getName(), countryUpdate.getName())){
            country.setName(countryUpdate.getName());
        }
        if (countryUpdate.getFlag()!=null &&
                countryUpdate.getFlag().length() > 0 &&
                !Objects.equals(country.getFlag(), countryUpdate.getFlag())){
            country.setFlag(countryUpdate.getFlag());
        }
        countryRepository.save(country);
    }
