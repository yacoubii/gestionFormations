...
public class ParticipantEntity {
    ...
    public ParticipantEntity(Long id, String firstName, String lastName, String email, String tel, EParticipant type, ProfileEntity profile, Set<SessionEntity> sessions) {
        this.id = id;
